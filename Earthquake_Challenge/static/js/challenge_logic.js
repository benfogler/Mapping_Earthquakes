...
// First layer group for the earthquake data.
let allEarthquakes = new L.LayerGroup();

// Second layer group for the tectonic plate data.
let tectonicPlate = new L.LayerGroup();

// Third layer group for the major earthquake data
...
let tectonicStyle ={
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(data) {
    // Pass tectonic plate data the geoJSON() layer
    L.geoJSON(data, {
      style: tectonicStyle,
      // onEachFeature: function(feature, layer)
    }).addTo(tectonicPlate);
